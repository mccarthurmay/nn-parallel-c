...
gcc -Wall -Wextra -std=c11 -O2 -fopenmp -o network_v3 main.c networkV3.c mnist_loader.c sigFuncs.c -lm
...
rm -f ./*.o
$CC -Wall -Wextra -std=c11 -DTAU_ENABLED -O3 -fopenmp -o networkV3 main.c networkV3.c mnist_loader.c sigFuncs.c -lm
rm -f ./*.o
